...
namespace Wombat.Extensions.JsonRpc.Client
{
    ...
    public class RpcClient : IDisposable
    {
        ...
        public async Task ConnectAsync(ITwoWayChannel transport)
        {
            ...
            try
            {
                ...
                // 创建JsonRpc实例
                _jsonRpc = new StreamJsonRpc.JsonRpc(_transport.InputStream, _transport.OutputStream);
    ...
    public class RpcClientStatistics
    {
        ...
        public TimeSpan? ConnectionDuration => ConnectedAt.HasValue ? (TimeSpan?)((DisconnectedAt ?? DateTime.UtcNow) - ConnectedAt.Value) : null;
