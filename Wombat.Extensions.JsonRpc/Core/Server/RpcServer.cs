...
namespace Wombat.Extensions.JsonRpc.Core.Server
{
    ...
    public class RpcServer : IDisposable
    {
        ...
        private void OnTcpClientConnected(object sender, ClientConnectedEventArgs e)
        {
        ...
        private void HandleClientConnection(ITwoWayChannel transport, TransportType transportType)
        {
            try
            {
                ...
                // 创建JsonRpc实例
                var jsonRpc = new StreamJsonRpc.JsonRpc(transport);
                ...
                // 配置JsonRpc事件
                jsonRpc.Disconnected += (s, args) => OnClientDisconnected(connectionId, args.Reason);
        ...
        private void OnClientDisconnected(string connectionId, StreamJsonRpc.JsonRpcDisconnectedEventArgs.DisconnectedReason reason)
        {
