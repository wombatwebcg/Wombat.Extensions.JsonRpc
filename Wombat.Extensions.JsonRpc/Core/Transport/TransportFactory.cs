...
namespace Wombat.Extensions.JsonRpc.Core.Transport
{
    /// <summary>
    /// 传输层工厂
    /// </summary>
    public class TransportFactory : ITransportFactory
    {
        ...
        public ITwoWayChannel CreateTransport(TransportConfiguration config)
        {
            ...
            try
            {
                ...
                {
                    TransportType.Tcp => CreateTcpClient(config.Host, config.Port, config.TcpOptions),
                    TransportType.NamedPipe => CreateNamedPipeClient(config.ServerName, config.PipeName, config.NamedPipeOptions),
